     ...
     <div class="box box-default">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="<?= base_url('pengaduan/kategori/'.$kategori['id_kategori']) ?>"><i class="fa fa-tag text-light-blue"></i> <?= ucwords(strtolower($kategori['nama_kategori']))  ?> [<?= $this->load_data->jumlah_post_kategori($kategori['id_kategori']) ?>]</a></li>
                <?php endforeach; ?>
              </ul>
            </div>
            <!-- /.box-body -->
