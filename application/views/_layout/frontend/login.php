...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url() ?>"><b>Lapor</b>Kan</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masuk ke dalam LaporKan</p>

    <form action="<?= base_url() ?>login/check" method="post" name="Form">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="NIK" id="UserName" name="nik" required>
      ...
      <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="sebagai">
