            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php foreach($pengguna as $p){ ?>
                  ...
                  ?></td> -->
                  <td><a href="<?= base_url('admin/admin/jabatan/nonaktif/'.$p['id_rj'].'html?jabatan=rt')  ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menonaktifkan pejabat ini?');">Nonaktifkan</a></td>
