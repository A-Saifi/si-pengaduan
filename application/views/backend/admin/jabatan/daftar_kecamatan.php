            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php foreach($pengguna as $p){ ?>
                  ...
                  <td><?php echo ucwords(strtolower($p['nama_kec'])); ?></td>
                  <td>
                  Kabupaten <?php echo $p['nama_kab']; ?>
              		</td>
                  <!-- <td><?php
                  switch ($p['nama_j']) {
                    case 'rt':
                  ...
                  ?></td> -->
                  <td><a href="<?= base_url('admin/admin/jabatan/nonaktif/'.$p['id_rj'].'html?jabatan=kecamatan')  ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menonaktifkan pejabat ini?');">Nonaktifkan</a></td>
