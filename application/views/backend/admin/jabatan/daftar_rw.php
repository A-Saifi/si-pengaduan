            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php foreach($pengguna as $p){ ?>
                  ...
                  <td><?php echo ucwords(strtolower($p['nama_dusun'])); ?></td>
                  <td>
                  ...
                  ?></td> -->
                  <td><a href="<?= base_url('admin/admin/jabatan/nonaktif/'.$p['id_rj'].'html?jabatan=rw')  ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menonaktifkan pejabat ini?');">Nonaktifkan</a></td>
