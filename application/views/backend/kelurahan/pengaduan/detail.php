<div class="content">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <?php $this->view('backend/kelurahan/penduduk/detail', ['data' => array_merge($pengaduan, $alamat)]) ?>
      ...
      <div class="box box-default">
                  ...
                  <div class="modal fade" id="disposisi" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <?= form_open(base_url('admin/kelurahan/disposisi/pengaduan/'.$pengaduan['id_pengaduan']));  ?>
            ...
            <div class="box-body">
              ...
              <?php if ($gambar!=null): ?>
                <?php $this->view('backend/kelurahan/pengaduan/foto', ['gambar' => $gambar]); ?>
              <?php endif; ?>
            ...
            <?php if ($komentar!=null): ?>
              <?php $this->view('backend/kelurahan/pengaduan/komentar', ['komentar' => $komentar,]); ?>
            <?php endif; ?>
            <!-- /.box-footer -->
    ...
    <div class="col-md-6">
            ...
            <?php if ($this->load_data_admin->cek_tanggapan_rt($pengaduan['id_pengaduan'], $userdata['id_rj']) && $this->load_data_admin->cek_status_disposisi($pengaduan['id_pengaduan'])): ?>
              <?php $this->view('backend/kelurahan/pengaduan/valid/form_klarifikasi', ['pengaduan' => $pengaduan]) ?>
            <?php endif; ?>


            <?php if ($this->load_data_admin->load_tanggapan($pengaduan['id_pengaduan'])!=null): ?>
              <?php $this->view('backend/kelurahan/pengaduan/tanggapan', ['tanggapan' => $this->load_data_admin->load_tanggapan($pengaduan['id_pengaduan'])]); ?>
            <?php endif; ?>
  ...
  <?php endif; ?>
    <div class="col-md-6">
      <?php $this->view('backend/kelurahan/pengaduan/lokasi', ['pengaduan' => $pengaduan]) ?>
    </div>
  </div>
</div>
