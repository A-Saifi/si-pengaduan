          ...
          <?php if ($pengaduan!=null): ?>
            ...
            <?php $no=0;
              ...
              <td><?= ucwords(strtolower($p['judul_pengaduan'])) ?></td>
          		...
          		<td><?= 'RT'.$p['nama_rt'].'/RW'.$p['nama_rw'].', '.$p['nama_kel'].', Kecamatan '.$p['nama_kec']; ?></td>

          		<td>
                <a class="btn btn-block btn-success btn-xs" href="<?= base_url('admin/kabupaten/pengaduan/detaillengkap/').$p['id_pengaduan'] ?>">Detail</a>
