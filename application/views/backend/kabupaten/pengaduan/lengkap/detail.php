<div class="content">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <?php $this->view('backend/kecamatan/penduduk/detail', ['data' => array_merge($pengaduan, $alamat)]) ?>
      ...
      <div class="box box-default">
            <div class="box-header with-border">
              ...
              <!-- /.user-block -->
              <div class="box-tools">
                <?php $this->view('backend/kabupaten/pengaduan/lengkap/berada', ['data' => $this->load_data_admin->load_asal_pengaduan($pengaduan['id_pengaduan']),]) ?>
                <a href="#" type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#<?= $pengaduan['id_pengaduan'] ?>">
                <i class="fa fa-check"></i> Berada di</a>
                <?php if ($pengaduan['status_pengaduan']=='belum valid'): ?>
                  <a href="<?= base_url('admin/kelurahan/spam/pengaduan/'.$pengaduan['id_pengaduan'])  ?>" type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" title="" data-original-title="Tandai sebagai spam" onclick="return confirm('Yakin ingin menandai pengaduan ini sebagai spam?');">
                  <i class="fa fa-trash-o"></i> Spam</a>
                    &nbsp; &nbsp;
                  <a href="<?= base_url('admin/kelurahan/validasi/pengaduan/'.$pengaduan['id_pengaduan'])  ?>" type="button" class="btn btn-info btn-sm" data-toggle="tooltip" title="" data-original-title="Menyatakan bahwa pengaduan ini benar" onclick="return confirm('Yakin ingin memvalidasi pengaduan ini?');">
                  ...
                  <div class="modal fade" id="disposisi" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <?= form_open(base_url('admin/kecamatan/disposisi/pengaduan/'.$pengaduan['id_pengaduan']));  ?>
                ...
                <?php if ($pengaduan['status_pengaduan']=='tidak valid'): ?>
                  <a href="<?= base_url('admin/kelurahan/spam/urungkan/'.$pengaduan['id_pengaduan'])  ?>" type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" title="" data-original-title="Urungkan untuk mengembalikan pengaduan" onclick="return confirm('Yakin ingin mengembalikan pengaduan ini?');">
                  <i class="fa fa-retweet"></i> Urungkan</a>
                <?php endif; ?>
              </div>
              <!-- /.box-tools -->
            ...
            <div class="box-body">
              ...
              <?php if ($gambar!=null): ?>
                <?php $this->view('backend/kecamatan/pengaduan/foto', ['gambar' => $gambar]); ?>
              <?php endif; ?>
            ...
            <?php if ($komentar!=null): ?>
              <?php $this->view('backend/kecamatan/pengaduan/komentar', ['komentar' => $komentar,]); ?>
            <?php endif; ?>
            <!-- /.box-footer -->
    ...
    <div class="col-md-6">
            ...
            <?php if ($this->load_data_admin->cek_tanggapan_rt($pengaduan['id_pengaduan'], $userdata['id_rj']) && $this->load_data_admin->cek_status_disposisi($pengaduan['id_pengaduan'])): ?>
              <?php $this->view('backend/kecamatan/pengaduan/valid/form_klarifikasi', ['pengaduan' => $pengaduan]) ?>
            <?php endif; ?>


            <?php if ($this->load_data_admin->load_tanggapan($pengaduan['id_pengaduan'])!=null): ?>
              <?php $this->view('backend/kecamatan/pengaduan/tanggapan', ['tanggapan' => $this->load_data_admin->load_tanggapan($pengaduan['id_pengaduan'])]); ?>
            <?php endif; ?>
  ...
  <?php endif; ?>
    <div class="col-md-6">
      <?php $this->view('backend/kecamatan/pengaduan/lokasi', ['pengaduan' => $pengaduan]) ?>
    </div>
  </div>
</div>
