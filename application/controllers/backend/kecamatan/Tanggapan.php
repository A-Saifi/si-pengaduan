...
class Tanggapan extends Backend
{
  ...
  public function index()
  {
    ...
    $data = [
      ...
      'crumb' =>  [
                    ...
                    ['label'=>'Tanggapan','link'=>'admin/kecamatan/tanggapan'],
                      ],
      'small' => 'Daftar Tanggapan',
      'tanggapan' => $tanggapan,
      'no' => 0,
    ];
    $this->layout->load_backend('backend/kecamatan/tanggapan/daftar', $data);
  }
  ...
  public function tambah($id_pengaduan)
  {
    ...
    $status = [
      ...
      'nama_status' => 'Telah ditanggapi oleh Petugas Kecamatan',
      'dibaca' => 'belum',
    ];
    ...
    $this->alert('Pengaduan berhasil menambahkan tanggapan', base_url('admin/kecamatan/pengaduan/detail/'.$id_pengaduan));
  ...
  public function hapus($id_pengaduan, $id_tanggapan)
  {
    ...
    $this->alert($this->Tanggapan_pengaduan_model->delete_tanggapan($id_tanggapan), base_url('admin/kecamatan/tanggapan'));
  }
  ...
  public function edit($id_tanggapan)
  {
    if ($id_tanggapan!=null) {
      ...
      $this->load->model('Tanggapan_pengaduan_model');
      $this->alert($this->Tanggapan_pengaduan_model->update_tanggapan($id_tanggapan, $data), base_url('admin/kecamatan/pengaduan/detail/'.$this->input->get('pengaduan')));
    }else {
        $this->alert('tidak ada yang bisa diubah', base_url('admin/kecamatan/tanggapan'));
    }
  }
}
