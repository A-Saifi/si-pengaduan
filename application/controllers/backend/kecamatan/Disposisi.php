  ...
  public function pengaduan($id_pengaduan)
  {
    ...
    if ($this->input->post('jabatan')!=null) {
      ...
      $status = [
        ...
        'nama_status' => 'Telah didisposisikan oleh Petugas Kecamatan',
        'dibaca' => 'belum',
      ];
      ...
      $this->alert('Berhasil Didisposisikan', base_url('admin/kecamatan/pengaduan/disposisi/'));
    }else {
        $this->alert('Maaf tidak lengkap', base_url('admin/kecamatan/pengaduan/detail/'.$id_pengaduan));
    }
