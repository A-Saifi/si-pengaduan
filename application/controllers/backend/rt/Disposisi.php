    ...
    if ($this->input->post('jabatan')!=null) {
      ...
      if ($jabatan['id_rj']!=null) {
        ...
        $status = [
          ...
          'nama_status' => 'Telah didisposisikan oleh Ketua RT',
          'dibaca' => 'belum',
        ];
        ...
        $this->alert('Berhasil Didisposisikan', base_url('admin/rt/pengaduan/disposisi/'));
      }else {
        $this->alert('Maaf pejabat yang dituju tidak ada', base_url('admin/rt/pengaduan/detail/'.$id_pengaduan));
      }

    }else {
        $this->alert('Maaf tidak lengkap', base_url('admin/rt/pengaduan/detail/'.$id_pengaduan));
    }
