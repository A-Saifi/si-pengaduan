  ...
  public function pengaduan($id_pengaduan)
  {
    ...
    if ($this->input->post('jabatan')!=null) {
      ...
      $status = [
        ...
        'nama_status' => 'Telah didisposisikan oleh Ketua RW',
        'dibaca' => 'belum',
      ];
      ...
      $this->alert('Berhasil Didisposisikan', base_url('admin/rw/pengaduan/disposisi/'));
    }else {
        $this->alert('Maaf tidak lengkap', base_url('admin/rw/pengaduan/detail/'.$id_pengaduan));
    }
